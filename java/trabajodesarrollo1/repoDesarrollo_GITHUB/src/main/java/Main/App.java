...
public class App {
     ...
     *
     * @param huespedDTO
     * la precondicion es q se haya ejecut el cu02
     * tengo al gestor para q realice los metodos, le paso a el el dto
     */
    public static void modificarHuesped(HuespedDTO huespedDTO, GestorHuesped gestorHuesped){

        gestorHuesped.modificarHuesped(huespedDTO); //le paso a gestor huesped y ahi hago la implementacion
